...
$lang_array = array(
  "client_nom"=>"Client",
  "client"=>"Aquesta versió per a equips client està destinada a tots aquells ordinadors que estan connectats a un servidor LliureX, bé siga en un model de centre o bé en un model d'aula tradicional.",
